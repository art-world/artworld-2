...
`assets/models/kiosk.glb` is the phone kiosk in the inside world. Scanned by
ARTWORLD, so there is no licence to chase. Its source is
`assets/Phone Booth/3DModel.glb`.
